...
public:
    ...
    bool RightScreenEntityCollision(Coordinates, float = 0);
    bool LeftScreenEntityCollision(Coordinates, float = 0);
    bool DownScreenEntityCollision(Coordinates, float = 0);
    bool UpScreenEntityCollision(Coordinates, float = 0);
    ...
    bool EntityWinnigBoundryCollision(Coordinates, float = 0);
